...
import { Check, Copy, Home, RefreshCw, Save, X } from 'lucide-react';
            ...
            <div className="p-4 pt-0">
                <Tabs defaultValue="wrong" className="w-full">
                    <TabsList className="grid w-full grid-cols-2">
                        <TabsTrigger
                            value="wrong"
                            className="gap-2 data-[state=active]:text-red-600 dark:data-[state=active]:text-red-400"
                        >
                            <X className="h-4 w-4" />
                        ...
                        <TabsTrigger
                            value="correct"
                            className="gap-2 data-[state=active]:text-green-600 dark:data-[state=active]:text-green-400"
                        >
