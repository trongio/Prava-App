...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Always use ATTACH method - it uses the current DB connection
        // which NativePHP has configured to the correct location.
        // File copy doesn't work on mobile because database_path() returns
        // a different location than where NativePHP stores the database.
        try {
